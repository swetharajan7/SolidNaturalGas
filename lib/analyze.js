...
// "finance" | "news" | "general" — price, storage and supply evidence is
// finance-shaped. Override with the TAVILY_TOPIC env var to compare.
const TAVILY_TOPIC = process.env.TAVILY_TOPIC || "finance";
